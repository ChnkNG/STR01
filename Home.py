...
with col1:
    st.image('./pic/Nueng.jpg')
with col2:
    st.image('./pic/Hydrangea.jpg')

html_1 = """
<div style="background-color:#FF90BC;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
